...
# GUI Title
titleTxt = ttk.Label(root, text=title, font=("Futura", 25, "bold"))
titleTxt.grid(pady=(60, 60))
...
select_button = ttk.Button(
    root, text="Seleziona l'immagine", width=35, command=selectImg
).grid(pady=(35, 10))

# Reset Image button
clear_button = ttk.Button(
    root, text="Deseleziona l'immagine", width=35, command=clear
).grid()

# Label for results
aiLabel = ttk.Label(
    root, textvariable=result_default, font=("Futura", 14), width=18
).grid(pady=(30, 0))

# Label for percentage
aiPercent = ttk.Label(
    root, textvariable=perc_default, font=("Futura", 14), width=18
).grid(pady=(0, 10))
...
creditsTxt.grid(pady=82, sticky=tk.E)
